...
async function loadAllData() {
  const [
    ...
    sbClient.from('npcs').select('*, ciudad:ciudades(id,notion_id,nombre), establecimiento:establecimientos(id,notion_id,nombre)').eq('archived', false),
    sbClient.from('establecimientos').select('*, ciudad:ciudades(id,notion_id,nombre), dueno:npcs(id,notion_id,nombre)').eq('archived', false),
    sbClient.from('items').select('*, personaje:personajes(id,notion_id,nombre)').eq('archived', false),
    sbClient.from('lugares').select('*, ciudad:ciudades(id,notion_id,nombre)').eq('archived', false),
